      ...
      return (
        ...
        <Row className="row-eq-height">
          <Col md="12">
             <Card>
                <CardBody>
                   <CardTitle>ค้นหากระบวนงาน</CardTitle>
                      ...
                      <Form>
                         ...
                         <div className="form-actions center">
                            <div className="float-none">
                               ...
                               <Button color="dark"  className="mr-1" onClick={this.onClickUploadFile} >
       ...
       <Row className="row-eq-height">
          <Col md="12">
             <Card>
                <CardBody>
                   <CardTitle>จัดการกระบวนงาน</CardTitle>
                    <DataTable schema='process' titleTable="รายการกระบวนงาน"/>
                </CardBody>
             </Card>
          </Col>
       </Row>
